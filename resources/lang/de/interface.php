...
return [
    ...
    'admin' => [
        ...
        'updates' => [
            'title' => 'Update',
            'subtitle' => 'Neue Projektversionen prüfen und installieren',
            'current_version' => 'Aktuelle Version',
            'latest_version' => 'Verfügbare Version',
            'released_at' => 'Veröffentlichungsdatum',
            'available' => 'Eine neue Version ist verfügbar',
            'not_available' => 'Keine Updates gefunden',
            'check_failed' => 'Prüfung nicht verfügbar',
            'unknown' => 'Unbekannt',
            'source' => 'Update-Quelle',
            'source_description' => 'Versionsinformationen werden vom Janickiy-Lizenzserver geladen.',
            'open_source' => 'Informationen öffnen',
            'release_notes' => 'Was ist neu',
            'run_to' => 'Auf :version aktualisieren',
            'up_to_date' => 'Die aktuelle Version ist installiert',
            'processing' => 'Update läuft...',
            'info_text' => 'Das System prüft den Lizenzserver und installiert das verfügbare Update-Paket.',
            'completed' => 'Update abgeschlossen. Version :version ist installiert.',
            'failed' => 'Update-Fehler: :message',
            'cannot_connect' => 'Verbindung zum Update-Server nicht möglich.',
            'download_missing' => 'Der Link zum Update-Paket ist nicht verfügbar.',
            'write_error' => 'Das Projektverzeichnis ist nicht beschreibbar.',
            'archive_error' => 'Archiv :file konnte nicht gelesen werden.',
            'unsafe_archive' => 'Archiv :file enthält unsichere Pfade.',
            'no_update' => 'Sie haben bereits die neueste Version :version.',
            'downloading' => ':file wird heruntergeladen ...',
            'extracting' => ':file wird entpackt ...',
            'database' => 'Datenbank wird aktualisiert ...',
            'cache' => 'Cache wird geleert ...',
            'download_completed' => 'Archiv :file heruntergeladen',
            'extract_completed' => 'Archiv :file entpackt',
            'database_completed' => 'Migrationen angewendet',
        ],
