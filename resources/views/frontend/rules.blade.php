        ...
        <ol>
            <li>Общие положения
                <ol>
                    ...
                    <li>catalog.janicky.com имеет право исключать из каталога сайты, а также изменять данные сайтов с целью
                    ...
                    <li>catalog.janicky.com оставляет за собой право в одностороннем порядке прекратить предоставление услуг без
                        указания причин.
                    </li>
                    <li>catalog.janicky.com не несет ответственности:
                        <ol>
                            ...
                            <li>за неисполнение обязательств в силу форс-мажорных обстоятельств. Под форс-мажорными
                                ...
                                сайтов catalog.janicky.com, в том числе: война, забастовка, восстание, любые другие социальные конфликты
                            ...
                            <li>за способы и последствия использования третьими лицами информации, размещенной в catalog.janicky.com;
                            </li>
                            <li>за надежность, качество и скорость работы catalog.janicky.com и сохранность размещенной информации.</li>
                        </ol>
                    </li>
                    <li>catalog.janicky.com не производит проверку правосубъектности лиц, зарегистрировавших сайты в каталоге.</li>
                    <li>catalog.janicky.com имеет право осуществлять рекламную деятельность.</li>
                    <li>catalog.janicky.com имеет право направлять по электронной почте пользователям информацию, имеющую отношение к
                        сайту.
                    </li>
                </ol>
            </li>
            <li>Права и обязанности пользователей каталога сайтов
                <ol>
                    ...
                    <li>Пользователь имеет право предложить администрации catalog.janicky.com варианты их изменения, отправив заявку в
            ...
            <li>Поддержка Пользователей каталога сайтов catalog.janicky.com
                <ol>
                    <li>По всем вопросам, связанным с catalog.janicky.com, информационная поддержка производится с помощью связи с
                        администрацией.
                    </li>
                    <li>Претензии, связанные с использованием catalog.janicky.com, принимаются по электронной почте через форму обратной
